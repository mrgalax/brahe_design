...
if (isset($_GET['date']) && isset($_SESSION['faktura'])) { 
	$date=$_GET['date'];
	$_SESSION['faktura']="<h3 class='nyhedGreen'>Tak for din bestilling!</h3><p class='text'>Vi kontakter dig indenfor 48 timer og aftaler vores første møde. Vi ser frem til samarbejdet, hav' en god dag!</p>".$_SESSION['faktura']."<br /><br />Dato for bestilling: ".date('l jS \of F Y ');
