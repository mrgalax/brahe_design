...
define('LOGOUT_URL', 'http://sune2109.keaweb.dk/Oestergreen_v3/index.php');
...
<body style="background-image:url(../images/bg3.png)">
  <style>
    input { 
	border:#5BADFF 2px solid;
	}
  </style>
  <div id="bodyContainerBotLeft" style="width:500px; margin-left:auto; margin-right:auto; text-align:center">
  <form method="post">
    <h3 class="nyhed">Username and password required</h3>
