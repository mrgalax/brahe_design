...
<div id="wowslider-container3" class="shadow">
    <div class="ws_images">
        <a href="index.php" target="_blank"><img src="wow_data/images/coffin.png" alt="coffin" title="Verdens Første 100% Grønne Kiste." id="wows0"/>Tryk på billedet for at læse mere.</a>
        <a href="index.php" target="_blank"><img src="wow_data/images/coffin2.png" alt="coffin2" title="Brahe Design Repræsenteret På 'Hello Materials'." id="wows1"/>Tryk på billedet for at læse mere.</a>
        <a href="index.php" target="_blank"><img src="wow_data/images/brahe.png" alt="brahe" title="En Personlig Virksomhed." id="wows2"/>Tryk på billedet for at læse mere.</a>
         <a href="index.php" target="_blank"><img src="wow_data/images/mellen.png" alt="mellen" title="Vi Designer I Alle Størrelser." id="wows3"/>Tryk på billedet for at læse mere.</a>
    </div>
    <div class="ws_bullets">
    	<div>
            <a href="#wows0" title="coffin"><img src="wow_data/tooltips/coffin.png" alt="coffin"/>1</a>
            <a href="#wows1" title="coffin2"><img src="wow_data/tooltips/coffin2.png" alt="coffin2"/>2</a>
            <a href="#wows2" title="brahe"><img src="wow_data/tooltips/brahe.png" alt="brahe"/>3</a>
            <a href="#wows3" title="mellen"><img src="wow_data/tooltips/mellen.png" alt="mellen"/>4</a>
    	</div>
    </div>
    <div class="ws_shadow"></div>
</div>
<script type="text/javascript" src="wow_engine/script.js"></script>
<!-- End Slider BODY section -->

<!-- Start left bottom box -->
<div id="bodyContainerBotLeft" class="shadow">
	<h3 class="nyhed">Velkommen</h3>
        <p class="text">
            Brahe Design blev etableret i 1993 af Jakob Brahe-Pedersen på baggrund af mange års erfaring med industrielt design. 
            I næsten to årtier har Brahe design serviceret en bred vifte af industrier med design og ide-udvikling til deres produkter.
            
            <br /><br />Hos Brahe-Design opbygger vi langvarige relationer til vores kunder og har serviceret flere af vores klienter i mere end et årti. 
            Vi fokuserer på at tilføre en øget værdi til produkter ved hjælp af godt design kombineret med funktionalitet samt en god forståelse for den menneskelige faktor som gør at produkterne sælger. 
            Vores flade organisation og lille virksomheds størrelse sikrer et personligt samarbejde. Vores kunder er naturlig del af design-processen hvilket giver dem rig mulighed for at påvirke resultatet. 
            Vi har vores eget kvalitetsstyringssystem, som svarer til ISO 9001-2000.
        </p>
</div>
...
<div id="bodyContainerBotRight" class="shadow">
    <p class="text">
	Denne side er under udvikling af Sune Østergreen-Johansen, i samarbejde med GroupX; Mads Saust og Casper Splidsboel på KBH Erhversakademi.<br /> Dette er et eksamens semester projekt, ALT materiale/logoer/billeder på dette site, tilhører Brahe-Design samt ovenstående.
    </p> 
</div>
